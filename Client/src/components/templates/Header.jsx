...
export function Header() {
  ...
  return (
    <nav className="bg-dark_theme p-5 shadow flex justify-between md:items-center md:justify-between h-20 ">
      ...
      <ul
        className={`md:flex md:items-center z-[-1] md:z-auto md:static absolute bg-white w-full left-0 md:w-auto
        md:py-0 px-4 md:pl-0 pl-7 md:opacity-100 
        ${
          menu === faBars ? "top-[80px] opacity-100" : "top-[-400px] opacity-0"
        } 
      ...
      <div className="flex h-full justify-center">
        ...
        <span className="text-3xl cursor-pointer md:hidden block mx-2 inline">
          <FontAwesomeIcon
            icon={menu}
            onClick={toggleClick}
