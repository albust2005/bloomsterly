    ...
    <>
        {
            servicios.map(el => {
                ...
                return (
                    <div key={servicioL.id} className="flex bg-color_font_dark mb-[1vh] dark:bg-light_theme w-[124vh] p-[1vh] rounded-[2vh] items-center justify-between">
                        ...
                        <div className="w-[100vh] text-white dark:text-second_color_lt">
                            <h1 className="font-title mb-[1vh] text-2xl">{servicioL.nombre}</h1>
                            <p className="h-[12vh] overflow-hidden">{servicioL.descripcion}</p>  
                        </div>
                    </div>
                )
            })
